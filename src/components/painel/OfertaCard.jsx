/**
 * Card genérico de item do painel (produto / serviço) no grid.
 */
export default function OfertaCard({ nome, descricao, imagem, preco, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    >
      ...
      <span className="flex flex-1 flex-col gap-1 p-4">
        ...
        {preco ? (
          <span className="mt-auto pt-2 text-sm font-medium text-accent">{preco}</span>
        ) : null}
      </span>
    </button>
  )
